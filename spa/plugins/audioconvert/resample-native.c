...
static const struct quality blackman_qualities[] = {
	...
	{ 24, 0.857, 0.77, { 0.16, }},
	{ 32, 0.889, 0.82, { 0.16, }},
	{ 48, 0.923, 0.87, { 0.16, }},                  /* default */
	{ 64, 0.941, 0.895, { 0.16, }},
	{ 80, 0.952, 0.910, { 0.16, }},
	{ 96, 0.960, 0.925, { 0.16, }},
	{ 128, 0.970, 0.942, { 0.16, }},
	{ 144, 0.973, 0.950, { 0.16, }},
	{ 160, 0.976, 0.958, { 0.16, }},
	{ 192, 0.980, 0.966, { 0.16, }},
	{ 256, 0.985, 0.975, { 0.16, }},
...
static const struct quality exp_qualities[] = {
	{ 8, 0.667, 0.58, { 16.97789, }},
	{ 16, 0.80, 0.70, { 16.97789, }},
	{ 24, 0.857, 0.77, { 16.97789, }},
	{ 32, 0.889, 0.82, { 16.97789, }},
	{ 48, 0.923, 0.87, { 16.97789, }},                  /* default */
	{ 64, 0.941, 0.895, { 16.97789, }},
	{ 80, 0.952, 0.910, { 16.97789, }},
	{ 96, 0.960, 0.925, { 16.97789, }},
	{ 128, 0.970, 0.942, { 16.97789, }},
	{ 144, 0.973, 0.950, { 16.97789, }},
	{ 160, 0.976, 0.958, { 16.97789, }},
	{ 192, 0.980, 0.966, { 16.97789, }},
	{ 256, 0.985, 0.975, { 16.97789, }},
...
static const struct quality kaiser_qualities[] = {
	{ 8, 0.727, 0.62, { 3.553376, 110.0, 0.888064 }},
	{ 16, 0.842, 0.78, { 3.553376, 110.0, 0.444032 }},
	{ 24, 0.889, 0.82, { 3.904154, 120.0, 0.325043 }},
	{ 32, 0.914, 0.865, { 4.254931, 130.0, 0.265548 }},
	{ 48, 0.941, 0.895, { 4.254931, 130.0, 0.177032 }},
	{ 64, 0.955, 0.915, { 4.254931, 130.0, 0.132774 }},
	{ 80, 0.964, 0.928, { 4.254931, 130.0, 0.106219 }},
	{ 96, 0.970, 0.942, { 4.254931, 130.0, 0.088516 }},
	{ 128, 0.977, 0.952, { 4.254931, 130.0, 0.066387 }},
	{ 160, 0.982, 0.960, { 4.254931, 130.0, 0.053110 }},
	{ 192, 0.985, 0.968, { 4.254931, 130.0, 0.044258 }},
	{ 256, 0.988, 0.976, { 4.605709, 140.0, 0.035914 }},
	{ 512, 0.985, 0.985, { 4.781097, 145.0, 0.018637 }},
	{ 768, 0.990, 0.990, { 4.956486, 150.0, 0.012878 }},
	{ 1024, 0.993, 0.993, { 5.131875, 155.0, 0.009999 }},
};
...
int resample_native_init(struct resample *r)
{
	...
	/* When upsampling with default cutoff, rounding n_taps up may
	 * give extra taps. Use them for a higher cutoff:
	 *   cutoff = n_taps / (n_taps + K)
	 * K=3 for kaiser (better sidelobe control), K=4 for others. */
	if (out_rate >= in_rate && c->cutoff == cutoff) {
		double k = c->window == RESAMPLE_WINDOW_KAISER ? 3.0 : 4.0;
		double max_cutoff = SPA_MIN((double)n_taps / (n_taps + k), 0.99);
		if (max_cutoff > scale)
			scale = max_cutoff;
	}
