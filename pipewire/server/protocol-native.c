...
static void
core_update_map (struct pw_client *client)
{
  ...
  pw_core_notify_update_types (client->core_resource,
                               client->n_types,
                               diff,
                               types);
  client->n_types += diff;
                             ...
                             size_t  size)
{
  ...
  ((struct pw_core_methods*)resource->implementation)->update_types (resource, first_id, n_types, types);
  return true;
}
                                ...
                                uint32_t       id)
{
  ...
  pw_connection_end_write (connection, resource->id, PW_REGISTRY_EVENT_GLOBAL_REMOVE, b.b.offset);
}
                              ...
                              uint32_t      port_id)
{
  ...
  pw_connection_end_write (connection, resource->id, PW_CLIENT_NODE_EVENT_ADD_PORT, b.b.offset);
}
                                 ...
                                 uint32_t      port_id)
{
  ...
  pw_connection_end_write (connection, resource->id, PW_CLIENT_NODE_EVENT_REMOVE_PORT, b.b.offset);
}
                                ...
                                const struct spa_format *format)
{
  ...
  pw_connection_end_write (connection, resource->id, PW_CLIENT_NODE_EVENT_SET_FORMAT, b.b.offset);
}
                                  ...
                                  const void        *value)
{
  ...
  pw_connection_end_write (connection, resource->id, PW_CLIENT_NODE_EVENT_SET_PROPERTY, b.b.offset);
}
                                 ...
                                 struct pw_client_node_buffer *buffers)
{
  ...
  pw_connection_end_write (connection, resource->id, PW_CLIENT_NODE_EVENT_USE_BUFFERS, b.b.offset);
}
                                  ...
                                  const struct spa_command *command)
{
  ...
  pw_connection_end_write (connection, resource->id, PW_CLIENT_NODE_EVENT_NODE_COMMAND, b.b.offset);
}
                                  ...
                                  const struct spa_command *command)
{
  ...
  pw_connection_end_write (connection, resource->id, PW_CLIENT_NODE_EVENT_PORT_COMMAND, b.b.offset);
}
                               ...
                               uint32_t           size)
{
  ...
  pw_connection_end_write (connection, resource->id, PW_CLIENT_NODE_EVENT_TRANSPORT, b.b.offset);
}
                              ...
                              size_t size)
{
  ...
  ((struct pw_client_node_methods*)resource->implementation)->update (resource, change_mask, max_input_ports, max_output_ports, props);
  return true;
}
...
bool
pw_protocol_native_server_setup (struct pw_resource *resource)
{
