...
/* Identify 1722.1 7.3.5.2 Also defined in the Milan V1.2 - 5.4.5.4   */
...
#define BASE_CTRL_TYPE_MAC            { 0x91, 0xe0, 0xf0, 0x01, 0x00, 0x00 };
// TODO AVB, for now support limited to the Milan
#define BASE_CTRL_IDENTIFY_MAC        { 0x91, 0xe0, 0xf0, 0x00, 0x00, 0x01 };
